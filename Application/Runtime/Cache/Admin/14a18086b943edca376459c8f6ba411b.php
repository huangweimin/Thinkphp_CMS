   ...
   <!-- 内容区域 -->
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-border-form tpl-form-border-br">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="title" placeholder="请输入标题文字" value="<?php echo ($news_detail["title"]); ?>">
                                 ...
                                 <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="4" id="desc" placeholder="请输入简介"><?php echo ($news_detail["desc"]); ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="10" id="content" placeholder="请输入文章内容"><?php echo ($news_detail["content"]); ?></textarea>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            //还原值
            var $news_detail = <?php echo (json_encode($news_detail )); ?>
