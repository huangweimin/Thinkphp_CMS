            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-nav-link">
                    <a href="/Admin/Product/index">
                        <i class="am-icon-wpforms sidebar-nav-link-logo"></i> 产品
                    </a>
                </li>
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">新闻管理</div>
                            ...
                            <form class="am-form tpl-form-border-form tpl-form-border-br">
                                <div class="am-form-group">
                                 ...
                                 <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="4" id="user-intro" placeholder="请输入简介"></textarea>
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label for="user-phone" class="am-u-sm-3 am-form-label">新闻类型 <span class="tpl-form-line-small-title">Type</span></label>
                                    <div class="am-u-sm-9">
                                ...
                                <div class="am-form-group">
                                    <label for="user-intro" class="am-u-sm-3 am-form-label">显示文章</label>
                                    <div class="am-u-sm-9">
