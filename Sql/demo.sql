...
-- ----------------------------
BEGIN;
INSERT INTO `tp_about` VALUES ('这是关于我们的内容');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tp_news` VALUES (1, '想pick坤音四子', '和头脑风暴一起见证卜可思议啦！\n《机器人争霸》经历了种种磨难就要到决赛啦，男神的颜值你还没有看够？炫酷的机甲还让你有些迷茫？放心跟我们一起来，现场教学机器人最全知识点，围&lt;span style=&quot;background-color:#FF9900;&quot;&gt;观狂炫拽的机器人battle 23123&amp;nbsp; 123123&lt;/span&gt;', '2018-06-11 13:14:46', '行业新闻', '1', '和头脑风暴一起见证卜可思议啦！', 2, 0);
...
-- ----------------------------
BEGIN;
INSERT INTO `tp_user` VALUES (1, 'e10adc3949ba59abbe56e057f20f883e', 'admin', 'admin@qq.com', '2018-06-13 14:38:10', '1');
COMMIT;
